...
class ModelTrainer():
    ...
    def evaluate_model(self , X_train , y_train , X_test, y_test):
        try:
            ...
            report = report.sort_values(by="average_score" , ascending= False)
    ...
    def iniatiate_model_training(self ,train_array , test_array  ):
        try:
            ...
            if best_model_score <= self.threshold:
                raise CustomException("best model couldn't be found")
